...
'''sh
	docker volume create --name vol_postgis_dfnoponto --opt type=none --opt device=C:\docker\postgis-dfnoponto --opt o=bind
	docker volume create --name vol_nginx_conf_dfnoponto --opt type=none --opt device=C:\docker\fontend-dfnoponto\conf --opt o=bind
	docker volume create --name vol_nginx_web_dfnoponto --opt type=none --opt device=C:\docker\fontend-dfnoponto\web --opt o=bind
	docker volume create --name vol_service_app_dfnoponto --opt type=none --opt device=C:\docker\backend-dfnoponto\app --opt o=bind
	docker volume create --name vol_service_log_dfnoponto --opt type=none --opt device=C:\docker\backend-dfnoponto\log --opt o=bind
'''
